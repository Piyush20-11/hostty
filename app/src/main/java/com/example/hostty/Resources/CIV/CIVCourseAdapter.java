...
import com.example.hostty.Resources.CIV.CIVResourceDocs;
import com.example.hostty.Resources.CourseClass;

import java.util.ArrayList;
import java.util.List;

public class CIVCourseAdapter extends BaseAdapter {

    private Context mContext;
    private List<CourseClass> courseList;


    CIVCourseAdapter(Context context, ArrayList<CourseClass> arrayList) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(mContext, CIVResourceDocs.class);
                intent.putExtra("civCourseName",course.getCourseName());
                intent.putExtra("civCourseNo",course.getCourseNo());
