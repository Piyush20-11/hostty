package com.example.hostty.Mess.messnotification;
...
import com.example.hostty.Account.SplashActivity;
...
public class BreakfastAlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        builder.setSmallIcon(R.mipmap.icon_mnnit);
        builder.setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.mipmap.icon_mnnit));
